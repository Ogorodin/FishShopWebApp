...
public interface IUsersRepository extends CrudRepository<Users, Integer> {
	...
	void insertEmployeeWithDetails(
			@Param(value = "firstName") String firstName, @Param(value = "lastName") String lastName, @Param(value = "address") String address,
			@Param(value = "username") String username, @Param(value = "password") String password,	@Param(value = "email") String email);
